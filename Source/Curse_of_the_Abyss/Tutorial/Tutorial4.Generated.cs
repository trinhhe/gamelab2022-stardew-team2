...
namespace Curse_of_the_Abyss
{
	partial class Tutorial4: Panel
	{
		private void BuildUI()
		{
			...
			image3.Renderable = MyraEnvironment.DefaultAssetManager.Load<TextureRegion>("Content/UI/tutorial_4.png");
			image3.Left = 0;
			image3.Top = 0;
			...
			{
				Game._desktop.Root = Game._mainmenu.tut3_screen;
			};

			imageButton2.Click += (s, a) =>
			{
				Game._desktop.Root = Game._mainmenu.tut5_screen;
			};
		}
