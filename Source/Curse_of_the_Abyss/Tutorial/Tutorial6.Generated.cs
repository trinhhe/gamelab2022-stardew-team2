...
namespace Curse_of_the_Abyss
{
	partial class Tutorial6: Panel
	{
		private void BuildUI()
		{
			...
			image3.Renderable = MyraEnvironment.DefaultAssetManager.Load<TextureRegion>("Content/UI/tutorial_6.png");
			image3.Left = 0;
			image3.Top = 0;
			...
			{
				Game._desktop.Root = Game._mainmenu.tut7_screen;
			};
		}
