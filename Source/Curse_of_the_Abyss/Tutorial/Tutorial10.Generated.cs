...
{
	partial class Tutorial10: Panel
	{
		private void BuildUI()
		{
			...
			image3.Renderable = MyraEnvironment.DefaultAssetManager.Load<TextureRegion>("Content/UI/tutorial_10.png");
			image3.Left = 0;
			image3.Top = 0;
			...
			{
				Game._desktop.Root = Game._mainmenu.tut9_screen;
			};

			imageButton2.Click += (s, a) =>
			{
				Game._desktop.Root = Game._mainmenu.tut11_screen;
			};
		}
