...
namespace Curse_of_the_Abyss
{
	partial class Tutorial9: Panel
	{
		private void BuildUI()
		{
			...
			image3.Renderable = MyraEnvironment.DefaultAssetManager.Load<TextureRegion>("Content/UI/tutorial_9.png");
			image3.Left = 0;
			image3.Top = 0;
			...
			{
				Game._desktop.Root = Game._mainmenu.tut8_screen;
			};

			imageButton2.Click += (s, a) =>
			{
				Game._desktop.Root = Game._mainmenu.tut10_screen;
			};
		}
